...
The module still exports the same public helpers that `main.py` expects:
    Block, rectangular_layout, wheel_layout, minimum_wheel_radius,
    make_cost_fn, simulated_annealing  (generator version)
"""
...
FINAL_GAP   = 4.0          # finishes with 2–3 tracks between blocks
...
def make_cost_fn(mtj_blocks: List[Block],
    ...
    def cost(blocks: Iterable[Block]) -> float:
        ...
        # hard constraints enforced AGAIN inside cost (belt‑and‑braces)
